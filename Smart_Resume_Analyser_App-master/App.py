...
def run():
    ...
    link = '[©Developed by Tushar](http://www.tusharjaiswal.com)'
    st.sidebar.markdown(link, unsafe_allow_html=True)
    #st.sidebar("C:\\Users\\lenovo\\OneDrive\\Desktop\\train\\project\\Smart_Resume_Analyser_App-master\\Logo\\SRA_Logo.ico", use_column_width=True)
    img = Image.open('C:\\Users\\lenovo\\OneDrive\\Desktop\\train\\project\\Smart_Resume_Analyser_App-master\\Logo\\SRA_Logo.jpg')
    ...
    if choice == 'Normal User':
        ...
        if pdf_file is not None:
            with st.spinner('Uploading your Resume....'):
                 time.sleep(3)
            save_image_path = 'C:\\Users\\lenovo\\OneDrive\\Desktop\\train\\project\\Smart_Resume_Analyser_App-master\\Uploaded_Resumes'+pdf_file.name
        ...
        if st.button('Login'):
            if ad_user == 'tushar' and ad_password == 'jaiswal':
                st.success("Welcome Tushar Jaiswal")
                # Display Data
